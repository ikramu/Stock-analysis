...
def getYahooFinanceData(tickers):
    tickers = ["'HM B'", "'OMXC20'", "'OMXC25'", "'OMXH25'", "'OMXHPI'", "'OMXS30'"]
...
def main():
    ...
    unNormalizedDataBatch = getStartingData(claTrain, scaler, dbIds)
    ...
    while True:
        ...
        curStockBatch = getNextStockValue(curStockBatch, dbIds)
        sleep(60)
