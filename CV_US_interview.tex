...
\section{SUMMARY}
I have been working with big data at modeling, implementation, and analysis level for more than a decade. I have experience of analysing data from different domains including Telecom, Genomics, Stock Exchange and Call center processing. I have both academia and industry experience and have worked in companies ranging from ten to tens-of-thousands of people.
...
%-----------------------------------------%
{\bf \color{Black}{Higher secondary school,}} Engineering \\ % (CGPA 3.8 out of 4.0) \\
{\color{RubineRed}{Cadet Collage Razmak, Pakistan}} \hfill \textit{Jan 2002 -- Mar 2006} \\
...
I am driving data-driven cybersecurity research at DNEW Standards \& Technology. In this capacity, I conduct research and develop proof-of-concepts in the following areas. 
\begin{itemize}
...
\item Assisting in TA studies related to RAN security
%\item Assisting in long-term RAN security strategy 
\item Running academic collaborations in cybersecurity domain
...
\begin{itemize}
\item \textbf{Tumor evolution patterns in metastatic breast cancer}: Using phylogenetic methods, we inferred the mode of tumor progression in metastatic breast cancer patients. The paper has been published in Journal of Clinical Investigation (DOI: \href{https://doi.org/10.1172/JCI96149}{https://doi.org/10.1172/JCI96149})
\item \textbf{Quantifying intra-metastatic heterogeneity in breast cancer}: Using next generation DNA-sequencing data consisting of multiple blocks from the same metastasis, we quantified the extent of intra-metastatic heterogeneity and changing landscape of subclones in different regions of metastasis. We are now compiling the results and, based on their clinical value, will report them in high-impact journal.
\item \textbf{Research collaborations}: I am collaborating with my team members and other research teams (both within and outside Sweden) in computational analysis of cancer. See publications for some published work.
\end{itemize}
...
Mainly Python, R, C++ and Java. Others like Matlab and .Net when needed \\
{\bf \color{Brown}{Misc Tools:}} Bash, CMake, RapidMiner, Weka, Boost C++ libraries, OpenMPI \& Boost-MPI, MySQL, SQL Server, Elasticsearch, Git, SVN, Netbeans, Eclipse, and different Bioinformatics tools/pipelines. \\
...
{\bf \color{Brown}{Statistical Visualization and reporting:}} Different types of visualizations using matplotlib, ggplot2 and kibana.
%----------------------------------------------------------------------------------------
