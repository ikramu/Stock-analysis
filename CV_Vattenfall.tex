...
Mining terabytes of DNA/RNA sequencing data from breast cancer patients to infer the route of cancer spread (metastasis) from primary tumor to other organs. 
\begin{itemize} 
...
\item Main tools used are R, Bash, Python and various bioinformatics softwares (in Python, C++ and Java). 
...
{\bf \color{Brown}{Misc Tools:}} RapidMiner, Weka, Sparklyr (R interface for Spark), Bash, MySQL, PostgreSQL, CMake, Boost C++ libraries, OpenMPI \& Boost-MPI, Git, SVN, Netbeans, Eclipse, and different Bioinformatics tools and pipelines. \\
